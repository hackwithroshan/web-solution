...
import { LayoutGrid, Layers, CreditCard, Settings, LogOut } from 'lucide-react';
...
const UserSidebar: React.FC<UserSidebarProps> = ({ isOpen, setIsOpen }) => {
    ...
    const navLinks = [
        { icon: LayoutGrid, name: 'Dashboard', path: '/user/dashboard' },
        { icon: Layers, name: 'All Services', path: '/user/all-services' },
        { icon: CreditCard, name: 'Payment History', path: '/user/payment-history' },
        { icon: Settings, name: 'Account Settings', path: '/user/profile' },
    ];
