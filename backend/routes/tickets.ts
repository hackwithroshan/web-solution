...
router.get('/:id', async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        // FIX: Replaced `new mongoose.Types.ObjectId` with `new mongoose.mongo.ObjectId` to work around a type definition issue where the constructor was not expected to take arguments. This uses the underlying MongoDB driver's ObjectId class.
        const ticketId = new mongoose.mongo.ObjectId(req.params.id);
